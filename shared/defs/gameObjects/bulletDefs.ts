...
const SkinDefs: Record<string, BulletDef> = {
    ...
    bullet_m9_bonus: defineSkin("bullet_m9", {
        speed: 106.25,
        distance: 125
    }),
    bullet_mac10_bonus: defineSkin("bullet_mac10", {
        speed: 93.75,
        distance: 62.5
    }),
    bullet_ump9_bonus: defineSkin("bullet_ump9", {
        speed: 125,
        distance: 125
    }),
    bullet_vector_bonus: defineSkin("bullet_vector", {
        speed: 110,
        distance: 57.5
    }),
    bullet_glock_bonus: defineSkin("bullet_glock", {
        speed: 87.5,
        distance: 55
    }),
    bullet_m93r_bonus: defineSkin("bullet_m93r", {
        speed: 106.25,
        distance: 125
    }),
    bullet_scorpion_bonus: defineSkin("bullet_scorpion", {
        speed: 112.5,
        distance: 150,
        tracerColor: "9mm_suppressed_bonus"
    }),
    bullet_vss_bonus: defineSkin("bullet_vss", {
        speed: 118.75,
        distance: 156.25,
        tracerColor: "9mm_suppressed_bonus"
    }),
    bullet_p30l_bonus: defineSkin("bullet_p30l", {
        speed: 117.5,
        distance: 125
    })
};
