  ...
  return {
      ...
      surfaces: [
        {
          ...
          collision: [
            e.open
              ...
              : collider.createAabbExtents(v2.create(0, 0), v2.create(2.5, 8)),
          ],
        },
      ],
      imgs: [
    ...
    ceiling: {
      zoomRegions: [
        {
          zoomIn: e.open
            ? collider.createAabbExtents(v2.create(0, 0), v2.create(2.5, 5.75))
      ...
      surfaces: [
        {
          type: "container",
          collision: [
            collider.createAabbExtents(v2.create(-3.5, 0), v2.create(10, 10.5)),
          ],
        },
      ],
      imgs: [
      ...
      surfaces: [
        {
          ...
          collision: [
            ...
            collider.createAabbExtents(v2.create(-10.65, 7), v2.create(2, 12)),
      ...
      surfaces: [
        {
          ...
          collision: [
            ...
            collider.createAabbExtents(v2.create(0, -10.15), v2.create(2, 1.5)),
          ],
        },
      ],
      imgs: [
...
export const MapObjectDefs: Record<string, MapObjectDef> = {
      ...
      surfaces: [
        {
          ...
          collision: [
            ...
            collider.createAabbExtents(v2.create(5, 11.5), v2.create(47, 51.5)),
  ...
  archway_01: {
    ...
    ceiling: {
      zoomRegions: [],
      collision: [
        collider.createAabbExtents(v2.create(0, 0), v2.create(10.5, 2)),
      ],
      imgs: [
        {
  ...
  river_town_01: {
    ...
    bridgeWaterBounds: [
      collider.createAabbExtents(v2.create(0, 0), v2.create(5, 5)),
    ],
    mapObstacleBounds: [
      ...
      surfaces: [
        ...
        },
        {
          ...
          collision: [
            ...
            collider.createAabbExtents(v2.create(77.5, 64), v2.create(23, 10)),
            collider.createAabbExtents(
              v2.create(111, -29.5),
              v2.create(10.5, 24.5)
            ),
      ...
      surfaces: [
        ...
        },
        {
          ...
          collision: [
            ...
            collider.createAabbExtents(v2.create(45, -34), v2.create(5.75, 14)),
          ],
        },
      ],
      imgs: [
      ...
      surfaces: [
        {
          ...
          collision: [
            collider.createAabbExtents(v2.create(1, 1.5), v2.create(8, 5.5)),
            collider.createAabbExtents(v2.create(-10.65, 9), v2.create(2, 12)),
            collider.createAabbExtents(v2.create(-7.75, 3), v2.create(1, 2)),
            collider.createAabbExtents(v2.create(5, -4.75), v2.create(2, 1)),
          ],
        },
        ...
        surfaces: [
          {
            type: "shack",
            collision: [
              collider.createAabbExtents(v2.create(0, 0), v2.create(4.25, 5)),
              collider.createAabbExtents(v2.create(5, 0), v2.create(1.25, 2)),
              collider.createAabbExtents(v2.create(-5, 0), v2.create(1.25, 2)),
            ],
          },
        ],
      ...
      surfaces: [
        {
          type: "house",
          collision: [
            collider.createAabbExtents(v2.create(0, 0), v2.create(20.5, 20.5)),
        ...
        surfaces: [
          ...
          },
          {
            ...
            collision: [
              ...
              collider.createAabbExtents(v2.create(6.5, 7), v2.create(2.5, 3)),
              collider.createAabbExtents(
                v2.create(23.5, -3),
                v2.create(5.75, 2.5)
              ),
        ...
        surfaces: [
          {
            type: "tile",
            collision: [
              collider.createAabbExtents(v2.create(2, 9.5), v2.create(20, 22)),
              collider.createAabbExtents(v2.create(0, 7.5), v2.create(26, 48)),
              collider.createAabbExtents(v2.create(-26, -26), v2.create(4, 3)),
            ],
          },
        ],
        imgs: [
        ...
        surfaces: [
          {
            type: "shack",
            collision: [
              collider.createAabbExtents(v2.create(0, 0), v2.create(7.5, 6.5)),
            ],
          },
        ],
        imgs: [
      ...
      surfaces: [
        ...
        },
        {
          ...
          collision: [
            ...
            collider.createAabbExtents(v2.create(40.5, -62), v2.create(9.5, 8)),
          ],
        },
      ],
      imgs: [
      ...
      surfaces: [
        {
          type: "tile",
          collision: [
            collider.createAabbExtents(v2.create(0, 1.5), v2.create(9.5, 12.5)),
          ],
        },
      ],
      imgs: [
      ...
      surfaces: [
        {
          ...
          collision: [
            ...
            collider.createAabbExtents(v2.create(-2.5, 9.5), v2.create(6, 2.5)),
  ...
  bunker_structure_03: {
    ...
    mask: [
      collider.createAabbExtents(v2.create(8.5, -3.7), v2.create(18, 9.5)),
    ],
  },
  bunker_conch_01: {
    type: "building",
      ...
      surfaces: [
        {
          ...
          collision: [
            ...
            collider.createAabbExtents(v2.create(22, 3.35), v2.create(8, 2.5)),
            collider.createAabbExtents(
      ...
      surfaces: [
        {
          type: "water",
          collision: [
            collider.createAabbExtents(v2.create(1, -2.5), v2.create(15, 15.5)),
          ],
        },
      ],
      imgs: [
  ...
  bunker_structure_07: {
    ...
    mask: [
      collider.createAabbExtents(v2.create(0, -22.2), v2.create(13.5, 28)),
    ],
  },
  ...
  bunker_structure_09: {
    ...
    mask: [
      collider.createAabbExtents(v2.create(0, 0), v2.create(16.75, 11.75)),
    ],
  },
        ...
        surfaces: [
          {
            type: "asphalt",
            collision: [
              collider.createAabbExtents(v2.create(0, 0), v2.create(38.5, 12)),
            ],
          },
        ],
        imgs: [
