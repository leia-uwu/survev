...
export const GameConfig = {
    ...
    player: {
        ...
        defaultItems: {
            ...
            scope: "8xscope",
            perks: [
                { type: "scavenger", droppable: false },
                { type: "hunted", droppable: false },
                { type: "chambered", droppable: false },
                { type: "splinter", droppable: false },
                { type: "small_arms", droppable: false },
                { type: "takedown", droppable: false },
                { type: "field_medic", droppable: false },
                { type: "tree_climbing", droppable: false },
                { type: "scavenger_adv", droppable: false },
                { type: "targeting", droppable: false },
                { type: "fabricate", droppable: false },
                { type: "endless_ammo", droppable: false },
                { type: "steelskin", droppable: false },
                { type: "martyrdom", droppable: false },
                { type: "targeting", droppable: false },
                { type: "explosive", droppable: false },
                { type: "self_revive", droppable: false },
                { type: "bonus_assault", droppable: false },
                { type: "inspiration", droppable: false },
                { type: "final_bugle", droppable: false },
                { type: "trick_drain", droppable: false },
                { type: "treat_12g", droppable: false },
                { type: "treat_762", droppable: false },
                { type: "treat_556", droppable: false },
                { type: "turkey_shoot", droppable: false },
