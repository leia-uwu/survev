...
import loadouts, { Loadout } from "./loadouts";
...
import { ObjectType, ObjectsFullData } from "../../../shared/utils/objectSerializeFns";
import { AudioManager } from "../audioManager";
import { ConfigManager } from "../config";
import { InputBinds } from "../inputBinds";
import { Account } from "../account";
import { OutfitDef } from "../../../shared/defs/objectsTypings";
...
export class LoadoutDisplay {
    ...
    updateCharDisplay(options = {} as Partial<{
        animType: number;
        animSeq: number;
        actionSeq: number;
        actionType: number;
