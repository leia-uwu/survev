...
import { Map } from '../map';
import { GunDef, ThrowableDef } from '../../../shared/defs/objectsTypings';
...
export class Touch {
    ...
    update(dt: number, activePlayer: Player, map: Map, camera: Camera, renderer: Renderer) {
...
class LineSprites {
    ...
    update(touch: Touch, activePlayer: Player, map: Map, camera: Camera, renderer: Renderer) {
        const visible =
