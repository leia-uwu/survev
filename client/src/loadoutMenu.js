    ...
    p(e, [
        {
            ...
            value: function() {
                ...
                if (!this.initialized) {
                    ...
                    $("#crosshair-size").on("input", (t) => {
                        e.updateLoadoutFromDOM();
                    });
                    $("#crosshair-stroke").on("input", (t) => {
                        e.updateLoadoutFromDOM();
                    });
                    this.container =
        ...
        },
        {
            ...
            value: function(e) {
                ...
                var t = $("<div/>");
                var r = this.categories[this.selectedCatIdx];
                for (
                    var a = 0;
