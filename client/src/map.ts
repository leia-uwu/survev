...
import { GroundPatch, MapMsg } from "../../shared/msgs/mapMsg";
import { Collider, coldet } from "../../shared/utils/coldet";
...
import { Emitter, ParticleBarn } from "./objects/particles";
import { Player, PlayerBarn } from "./objects/player";
import { SmokeParticle } from "./objects/smoke";
...
export class Map {
    ...
    loadMap(mapMsg: MapMsg, camera: Camera, canvasMode: boolean, particleBarn: ParticleBarn) {
    ...
    update(dt: number, activePlayer: Player, playerBarn: PlayerBarn, particleBarn: ParticleBarn, audioManager: AudioManager, ambience: Ambiance, renderer: Renderer, camera: Camera, smokeParticles: SmokeParticle[], debug: unknown) {
        this.I = true;
        this.Br = true;
    ...
    renderTerrain(groundGfx: PIXI.Graphics, gridThickness: number, canvasMode: boolean, mapRender: boolean) {
