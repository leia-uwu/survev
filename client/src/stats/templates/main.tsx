...
export default function (params: {
  gameModes: { desc: { name: string }; mapId: number }[];
}) {
  return (
    <>
      {/* Overview Card */}
          ...
          <div className="card-body">
            <div className="row card-row-top">
              <div className="col-12">
                <div
                  className="leaderboard-title ml-sm-3 ml-0 mr-0 mt-3"
        ...
        <div className="row">
          <div className="col-lg-2 col-3 pr-lg-3 pr-1">
            <select
              ...
              className="leaderboard-opt custom-select"
            >
              <option value="solo" data-l10n="stats-solo">
                Solo
              </option>
              <option value="duo" data-l10n="stats-duo">
                Duo
              </option>
              <option value="squad" data-l10n="stats-squad">
                Squad
              </option>
            </select>
          </div>
          <div className="col-lg-2 col-3 pl-lg-0 pr-lg-3 pl-0 pr-1">
            <select
              ...
              className="leaderboard-opt custom-select"
            >
              <option value="most_kills" data-l10n="stats-most-kills">
                Most kills
              </option>
              <option value="most_damage_dealt" data-l10n="stats-most-damage">
                Most damage
              </option>
              <option value="kpg" data-l10n="stats-kpg-full">
                Kills per game
              </option>
              <option value="kills" data-l10n="stats-total-kills">
                Total kills
              </option>
              <option value="wins" data-l10n="stats-total-wins">
                Total wins
              </option>
            </select>
          </div>
          ...
          <div className="col-lg-2 col-3 pl-0">
            ...
            >
              {params.gameModes.map((mode, index) => (
                <option key={index} value={mode.mapId}>
                  {mode.desc.name}
                </option>
              ))}
            </select>
