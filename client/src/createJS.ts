...
import { ReverbDef, SoundDef } from "./soundDefs";
...
export class SoundInstance {
    ...
    start(destination: GainNode, buffer: AudioBuffer, volume: number, pan: number, loop: boolean, delay: number, offset: number, ambient: boolean, detune: number) {
...
class WebAudioEngine {
    ...
    registerSound(path: string, name: string, params: {
        canCoalesce?: boolean;
        volume?: number;
        channels?: number
    }) {
