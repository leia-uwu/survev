...
export class InputHandler {
    ...
    touchIdCounter = 0;
    lostFocus = false;
    captureNextInputCb: ((event: KeyboardEvent | MouseEvent | globalThis.TouchEvent, inputValue: InputValue ) => void) | null = null;

    constructor(
        public touchElem: HTMLElement 
    ) {
    ...
    checkCaptureInput(event: KeyboardEvent | MouseEvent | globalThis.TouchEvent, inputType: InputType, inputCode: number) {
        return (
