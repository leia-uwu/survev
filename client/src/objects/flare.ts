...
import { BulletDef } from "../../../shared/defs/objectsTypings";
...
export class FlareBarn {
    ...
    addFlare(
        ...
        // ~~ readonly L 
        const tracerColorDefs = GameConfig.tracerColors[bulletDef.tracerColor as keyof typeof GameConfig.tracerColors] as Record<string, number>;
    ...
    update(dt: number, playerBarn: unknown, map: Map, camera: unknown, activePlayer: Player, renderer: Renderer
        , particleBarn: unknown, audioManager: unknown) {
