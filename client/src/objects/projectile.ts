...
import { ThrowableDef } from "../../../shared/defs/gameObjects/throwableDefs";
...
class Projectile extends AbstractObject {
    ...
    updateData(data: ObjectData<ObjectType.Projectile>, fullUpdate: boolean, isNew: boolean, ctx: Ctx) {
        // Copy data
        if (fullUpdate) {
...
export class ProjectileBarn {
    ...
    update(dt: number, particleBarn: ParticleBarn, audioManager: AudioManager, activePlayer: Player, map: Map, renderer: Renderer, camera: Camera) {
