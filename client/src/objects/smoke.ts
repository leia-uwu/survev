...
class Smoke extends AbstractObject {
    ...
    updateData(data: ObjectData<ObjectType.Smoke>, fullUpdate: boolean, isNew: boolean, ctx: Ctx) {
        this.type = data.type;
...
export class SmokeBarn {
    ...
    update(dt: number, camera: Camera, activePlayer: Player, map: Map, renderer: Renderer) {
