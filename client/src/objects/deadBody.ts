...
class DeadBody implements AbstractObject {
    ...
    updateData(data: ObjectData<ObjectType.DeadBody>, fullUpdate: boolean, isNew: boolean, ctx: Ctx) {
...
export class DeadBodyBarn {
    ...
    update(dt: number, playerBarn: PlayerBarn, activePlayer: Player, map: Map, camera: Camera, renderer: Renderer) {
