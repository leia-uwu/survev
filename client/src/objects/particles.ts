...
export class Particle {
    ...
    o(renderer: Renderer, type: string, layer: number, pos: Vec2, vel: Vec2, scale: number, rot: number, parent: PIXI.Container | null, zOrd: number, valueAdjust: number) {
...
export class ParticleBarn {
    ...
    addParticle(type: string, layer: number, pos: Vec2, vel: Vec2, scale?: number, rot?: number, parent?: PIXI.Container | null, zOrd?: number) {
        let particle = null;
        for (let i = 0; i < this.particles.length; i++) {
