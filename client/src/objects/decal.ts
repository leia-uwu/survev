...
import { DecalDef } from "../../../shared/defs/mapObjectsTyping";
import { Map } from "../map";
...
class Decal extends AbstractObject {
    __id!: number;
    __type!: ObjectType;
    active!: boolean;
    ...
    updateData(data: ObjectData<ObjectType.Decal>, fullUpdate: boolean, isNew: boolean, ctx: Ctx) {
        if (fullUpdate) {
