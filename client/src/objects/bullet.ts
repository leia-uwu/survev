...
import { FlareBarn } from "./flare";
import { ParticleBarn } from "./particles";
import { Player, PlayerBarn } from "./player";
...
export function createBullet(bullet: Bullet, bulletBarn: BulletBarn, flareBarn: FlareBarn, playerBarn: PlayerBarn, renderer: Renderer) {
...
export function playHitFx(particleName: string, soundName: string, pos: Vec2, a: Vec2, layer: number, particleBarn: ParticleBarn, audioManager: AudioManager) {
...
export class BulletBarn {
    ...
    update(dt: number, playerBarn: PlayerBarn, map: Map, camera: Camera, activePlayer: Player, renderer: Renderer, particleBarn: ParticleBarn, audioManager: AudioManager) {
    ...
    createBulletHit(playerBarn: PlayerBarn, targetId: number, audioManager: AudioManager) {
