...
import { RoomData, TeamMenu } from "./ui/teamMenu";
...
class Application {
    ...
    tryLoad() { 
        if (
            ...
            (this.nameInput as unknown as HTMLInputElement).maxLength = net.Constants.PlayerNameMaxLen;
...
window.onerror = function(msg, url, lineNo, columnNo, error) {
    ...
    if (
        (msg as string).indexOf("').innerText") != -1 ||
