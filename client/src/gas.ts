...
export class GasRenderer {
    gasColorDOMString = "";
    display: PIXI.Sprite | PIXI.Graphics | null = null;
...
export class GasSafeZoneRenderer {
    ...
    render(safePos: Vec2, safeRad: number, playerPos: Vec2, drawCircle: boolean, drawLine: boolean) {
...
export class Gas {
    ...
    setFullState(circleT: number, data, map: unknown, ui: UiManager) {
        // Update Ui
