...
import { MeleeDef } from "../../shared/defs/gameObjects/meleeDefs";
import { OutfitDef } from "../../shared/defs/gameObjects/outfitDefs";
import { LootDef } from "../../shared/defs/objectsTypings";
...
export const helpers = {
    ...
    getSvgFromGameType: function(gameType: string) {
        const def = GameObjectDefs[gameType] as LootDef;
        ...
        case "outfit": {
            ...
            if (lootImg.sprite !== "loot-shirt-01.img") { return `img/loot/${lootImg.sprite.slice(0, -4)}.svg`; }
